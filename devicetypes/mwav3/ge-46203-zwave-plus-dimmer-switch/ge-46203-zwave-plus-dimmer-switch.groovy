 ...
 *	Changelog:
 *
 *  0.10 (09/15/2020) -	Initial 0.1 Beta. NOTE - This is a beta release, I have no switch to test it on
 *  
 *
 *   Button Mappings:
 *
...
metadata {
	definition (name: "GE 46203 Z-Wave Plus Dimmer Switch", namespace: "mwav3", author: "Tim Grimley") {
		capability "Actuator"
		capability "Button"
