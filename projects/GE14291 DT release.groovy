 ...
 *	Changelog:
 *
 *  0.13 (09/29/2020) - Support added for release after double tap and hold as button 3 pressed
...
def zwaveEvent(physicalgraph.zwave.commands.switchmultilevelv3.SwitchMultilevelStopLevelChange cmd) {
	...
	createEvent(name: "button", value: "pushed", data: [buttonNumber: 3], descriptionText: "Double-tap Release (button 3) on $device.displayName", isStateChange: true, type: "physical")    
}
